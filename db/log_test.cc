 ...
 public:
  LogTest()
      : reader_contents_(),
        ...
        writer_(&options_, std::move(dest_holder_), 123),
        reader_(&options_, std::move(source_holder_), &report_,
                true /*checksum*/, 0 /*initial_offset*/, 123) {}

  void SetUp() { options_.recycle_log_file_num = GetParam(); }
  ...
  void CheckOffsetPastEndReturnsNoRecords(uint64_t offset_past_end) {
    ...
    unique_ptr<Reader> offset_reader(
        new Reader(&options_, std::move(file_reader), &report_,
